...
<button class="btn btn-danger" disabled><a href="salabeb.pdf" class="text-light" download>View How to Use Api Documentation</a></button> <br><br>
...
$url = 'https://<?php echo $domain; ?>/app/customer/dev_data';<br/>
$ch = curl_init();<br/>
...
$url = 'https://<?php echo $domain; ?>/app/customer/dev_airtime';<br/>
$ch = curl_init();<br/>
curl_setopt($ch, CURLOPT_URL, $url);<br/>
curl_setopt($ch, CURLOPT_POST, 1);<br/>
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($payload));<br/>
...
$url = 'https://<?php echo $domain; ?>/app/customer/dev_cable';<br/>
$ch = curl_init();<br/>
curl_setopt($ch, CURLOPT_URL, $url);<br/>
curl_setopt($ch, CURLOPT_POST, 1);<br/>
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($payload));<br/>
...
$url = 'https://<?php echo $domain; ?>/app/customer/dev_bill';<br/>
$ch = curl_init();<br/>
curl_setopt($ch, CURLOPT_URL, $url);<br/>
curl_setopt($ch, CURLOPT_POST, 1);<br/>
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($payload));<br/>
...
$url = 'https://<?php echo $domain; ?>/app/customer/dev_epins';<br/>
$ch = curl_init();<br/>
curl_setopt($ch, CURLOPT_URL, $url);<br/>
curl_setopt($ch, CURLOPT_POST, 1);<br/>
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($payload));<br/>
