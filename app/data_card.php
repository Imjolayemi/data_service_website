...
<div class="alert" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 30px 60px -12px inset, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px inset;">
        ...
        <div id="response" style="text-align: left;">
          ...
          <center><span style="color: blue;font-weight: bold;font-size: 23px;">Load Code: *460*6*1*PIN#</span></center>
          <center><span style="color: green;font-weight: bold;font-size: 16px;">You Can also check your history to view your pin</span></center>
        </div>
