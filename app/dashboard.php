...
<input type="text" id="myCode" value="<?php echo $mainpage; ?>/register?referral=<?php echo $ref_code; ?>" style="background-color: transparent; color: transparent; height: 0px;border: none;">
<!--$username;-->
