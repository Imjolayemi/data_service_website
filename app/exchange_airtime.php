...
window.location.href="https://api.whatsapp.com/send?phone=<?php echo $whatsapp_no; ?>&text=Hello%20admin!%20i%20want%20to%20convert%20"+network_module+"%20₦"+amount+"%20to%20cash.";
}
else {
