...
$update=mysqli_query($con, "UPDATE web_settings SET api_mtn='$mtnsme_data', api_gift='$mtncg_data', api_glo='$glo_data', api_glocg='$glocg_data', api_airtel='$airtel_data', api_airtelcg='$airtelcg_data', api_mobile='$mobile_data' WHERE id='$level'");
