<?php
error_reporting(0);
$admin_pushfail='<div class="main_content_iner overly_inner ">
...
<div class="media_thumb ml_25">
	...
	<br>
	<center>
		<h3 style="font-weight: bold;font-size: 20px;">Sorry !!! '.$fullname.'</h3>
		<p>You have been restricted to see this page. </p>
	</center>
	<br>
	<br>
	<br>
